...
namespace TP_INTEGRADOR.Migrations
{
    ...
    [Migration("20230916192915_RoleToUser")]
            ...
            modelBuilder.Entity("TP_INTEGRADOR.Entities.Work", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CodService = 4,
                            Cost = 5m,
                            Date = new DateTime(2023, 9, 16, 16, 29, 15, 44, DateTimeKind.Local).AddTicks(9931),
                            ValuePerHour = 5m
                        },
                        new
                        {
                            ...
                            CodService = 3,
                            Cost = 12m,
                            Date = new DateTime(2023, 9, 16, 16, 29, 15, 44, DateTimeKind.Local).AddTicks(9955),
                            ValuePerHour = 6m
                        },
                        new
                        {
                            ...
                            CodService = 2,
                            Cost = 21m,
                            Date = new DateTime(2023, 9, 16, 16, 29, 15, 44, DateTimeKind.Local).AddTicks(9958),
                            ValuePerHour = 7m
                        },
                        new
                        {
                            ...
                            CodService = 1,
                            Cost = 32m,
                            Date = new DateTime(2023, 9, 16, 16, 29, 15, 44, DateTimeKind.Local).AddTicks(9961),
                            ValuePerHour = 8m
                        });
                });
